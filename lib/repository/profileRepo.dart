...
class CreateProfileRepo extends GetxController {
  ...
  var a = "";
  updateProfile(CreateProfileStudentModel profile) async {
    var result = await _db
        ...
        debugPrint(a);
        await _db.collection("Profiles")
        .doc(a).update(profile.toJson()).whenComplete(() => () => Utils.showSnackBar("Profile data added in firebase.", true))
        .catchError((error, stackTrace) {
      Utils.showSnackBar("Somethingwent wrong", true);
    });
  }
